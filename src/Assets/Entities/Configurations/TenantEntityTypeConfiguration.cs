...
namespace Assets.Entities.Configurations
{
    public class TenantEntityTypeConfiguration : IEntityTypeConfiguration<Tenant>
    {
        public void Configure(EntityTypeBuilder<Tenant> builder)
        {
            ...
            builder.HasKey(x => x.Id).HasName("PK_Tenant").ForSqlServerIsClustered();
            builder.HasAlternateKey(x => x.Area).HasName("AK_Tenant_Area");
            builder.HasAlternateKey(x => x.Name).HasName("AK_Tenant_Name");
